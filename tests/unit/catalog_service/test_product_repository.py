...
def test_product_repository_get():
    ...
    result = repo.get(mock_product.id)
...
def test_product_repository_create():
    ...
    mock_product = ProductORM(**mock_product_data)
    ...
    with patch.object(ProductORM, "__init__", return_value=None):
        result = repo.create(mock_product_data)
